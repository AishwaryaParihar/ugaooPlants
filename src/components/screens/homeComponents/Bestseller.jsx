  ...
  return (
    <div>
      ...
      <div className="heading">
          <h2><img src={bestSeller} alt="" className="seller-best"/> Bestsellers</h2>
        </div>
        <div className="row">
              ...
              <Card className="border border-0">
                ...
                <Badge bg="warning" text="dark">
                  ...
                  <Card.Body className="p-0 m-0">
                    ...
                    <p className="text-success h6"> <del className="text-secondary"><i class="fa-solid fa-indian-rupee-sign point12px"> </i> {product.delprice}</del> From <i class="fa-solid fa-indian-rupee-sign point12px"> </i> {product.price}</p>
